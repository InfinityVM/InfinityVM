...
abstract contract Consumer {
    ...
    function receiveResult(uint32 jobID, bytes calldata result) public onlyJobManager {
    ...
    function _receiveResult(uint32 jobID, bytes calldata result) internal virtual;
}
