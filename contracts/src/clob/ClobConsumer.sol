...
contract ClobConsumer is StatefulConsumer, SingleOffchainSigner {
    ...
    constructor(address jobManager, address offchainSigner, uint64 initialMaxNonce, IERC20 _baseToken, IERC20 _quoteToken, bytes32 latestStateOutputHash) StatefulConsumer(jobManager, initialMaxNonce, latestStateOutputHash) SingleOffchainSigner(offchainSigner) {
