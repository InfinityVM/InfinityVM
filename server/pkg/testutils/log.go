...
func NewTestLogger(t TestingT) zerolog.Logger {
...
// with verbose logs.
func NewTestLoggerInfo(t TestingT) zerolog.Logger {
...
// This is primarily helpful during active debugging of a test
// with verbose logs.
func NewTestLoggerError(t TestingT) zerolog.Logger {
	return newTestLogger(t, zerolog.ErrorLevel)
}

func newTestLogger(t TestingT, lvl zerolog.Level) zerolog.Logger {
	...
	return zerolog.New(cw).Level(lvl)
}
