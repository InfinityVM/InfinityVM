...
const (
	YourService_Echo_FullMethodName = "/infinityvm.server.v1.YourService/Echo"
)
...
var YourService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "infinityvm.server.v1.YourService",
	...
	Metadata: "infinityvm/server/v1/server.proto",
}
